...
public class Tower extends Model {
    ...
    public void setRange(int broadcastRange) {
        this.broadcastRange = broadcastRange;
    }

    public double getLatCoordDD(){
        return latCoordDD;
    }

    public void setLatCoordDD(int latCoordDD){
        this.latCoordDD = latCoordDD;
    }

    public double getLongCoordDD(){
        return longCoordDD;
    }

    public void setLongCoordDD(int longCoordDD){
